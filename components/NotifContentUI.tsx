...
export const BookingExpiredContent = ({ data }: { data: Record<string, any> }) => {
...
export const ScheduledChooseDriverContent = ({ data }: { data: Record<string, any> }) => {
    const { pickUp, dropOff } = data;
        ...
        <View className="gap-4">
            ...
            <View className="bg-blue-50 rounded-2xl p-5 border border-blue-200">
                <View className="flex-row items-center">
                    ...
                    <View className="flex-1">
                        <Text className="text-sm font-bold text-blue-900">Action Required</Text>
...
export const ScheduledNoDriversContent = ({ data }: { data: Record<string, any> }) => {
    const { pickUp, dropOff } = data;
        ...
        <View className="gap-4">
            ...
            <View className="bg-amber-50 rounded-2xl p-5 border border-amber-200">
                <View className="flex-row items-center">
                    ...
                    <View className="flex-1">
                        <Text className="text-sm font-bold text-amber-900">No Offers Yet</Text>
...
export const ScheduledAutoAssignWarningContent = ({ data }: { data: Record<string, any> }) => {
    const { pickUp, dropOff } = data;
        ...
        <View className="gap-4">
            ...
            <View className="bg-orange-50 rounded-2xl p-5 border border-orange-200">
                <View className="flex-row items-center">
                    ...
                    <View className="flex-1">
                        <Text className="text-sm font-bold text-orange-900">Auto-Assignment Soon</Text>
...
export const ScheduledAutoAssignedContent = ({ data }: { data: Record<string, any> }) => {
    const { pickUp, dropOff, driverName, driverRating, driverProfilePicture } = data;
...
export const ScheduledAutoCancelledContent = ({ data }: { data: Record<string, any> }) => {
    const { pickUp, dropOff } = data;
        ...
        <View className="gap-4">
            ...
            <View className="bg-red-50 rounded-2xl p-5 border border-red-200">
                <View className="flex-row items-center">
                    ...
                    <View className="flex-1">
                        <Text className="text-sm font-bold text-red-900">Booking Cancelled</Text>
